...
50814,42620,40667,40729,48951,53078,61238,44405},y,w;u*E,*C,K[2],M[2],A,X,Y,P=4,S=~2,h,l,i,j,L,r,v,x,t,t2,pm,p,H,pb,pw,fx,o,N,nb,pl,ph,vr[_*2],Pr[64],ra[_*8]
,cr[_*8],pr[_*8],oa[256],bm[]={128,64,1,2,1,0,0,1,4,0,0,4,0,0,64,0,8,0,0,8},ks,D,mb,F,I,c0,c1,J,b[_*_],*k;U T,V,f,d,e,a,s,c,fb[61440];u*q(U a){Q&C[M[a>>12]<<
12|a&4095];}u*nt(U a){Q&vr[!D?a%_:D==1?a%_+_:D==2?a&2047:a/2&_|a%_];}u m(u l,u h,u v,u w){U a=h<<8|l;Z(h>>4){W(0)...1:Q+w?ra[a]=v:ra[a];W(2)...3:l&=7;if(l==7
){t=pb;u*E=V                                                                                                                                     <_*8?!w||C==
cr?q(V):&t2:  V<16128?nt(V):Pr+(u)((V&19)==16?V^16:V);w?*E=v:(pb=*E);V+=p&4?32:1;V%=16*_;Q+t;}if(w)Z(l){W+0:p=v;T=T&62463|v%4<<10;W+1:pm=v;W+5:  T=(pw^=1)?fx
=v&7,T&~31|v  /8:T&35871|v%8<<12|v*4&992;W+6:T=(pw^=1)?(u)T|v%64<<8:(V=T&~255|v);}if(l==2)Q t=H&224,H&=127,pw=0,t;W+4:if(w&&l==20)for(f=256;f--  ;)oa[f]=m(f,
v,0,0);Q+l==  22?w?ks=(k[79]*8+k[80]*4+k[81]*2+k[82])*16+k[40]*8+k[43]*4+k[29]*2+k[27]:(t=ks&1,ks/=2,t):0;W(6)...7:Q+w?pr[a&8191]=v:pr[a&8191];  W(8)...15:if
(w)Z(b[6]>>4  ){W+7:D=!(v/16);*K=v=v%8*2;K[1]=v+1;W+3:*                                       M=v=v%4*2;M[1]=v+1;W+2:*K=v&31;W+1:v&128?mb=5,F=0  ,I|=12:(F=F/
2|v<<4&+16,!  --mb)?mb=5,t=a>>13,*(t==4?D=F&3,&I:t==5?&                                       c0:t==6?&c1:&J)=F,*M=c0&~!(I&16),M[1]=I&16?c1:c0|  1,t=I/4&3,*K
=t==2?0:t==3  ?J:J&~1,K[1]=t==2?J:t==3?b[4]-1:J|1:0;}Q+E[K[(a>>14)-2]<<14|a&16383];}Q~0;}u R(){v=m(l,h,0,0);!++l?++h:0;Q+v;}u n(u v){Q P=P&~130  |v&128|!v*2;
}int((main))  (int,char**av){SDL_RWread(SDL_RWFromFile(av[1],"rb"),b,_*_,1);E=b+16;K[1]=b[4]-1;C=b[5]?E+((K[1]+1)<<14):cr;M[1]=(b[5]?b[5]:1)*2-  1;D=3-b[6]%2
;l=m(~3,~0,0  ,0);h=m(~2,             ~0,0,0);SDL_Init(                                       32);void*re=SDL_CreateRenderer(SDL_CreateWindow((  "smolnes"),0
