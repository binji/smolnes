...
(t&~1)<<4|(j&8)*2|j&7:(p&8)<<9|t<<4|j&7,c=*q(a+8)>>i<<1&2|*q(a)>>i&1;if(c){!(s[2]&32&&C)?C=c,P=16|s[2]*4&12:0;s==oa&&C?H|=64:0;B}}}fb[y*256+d]=rg[Pr[C?P|C:0]
];}d<336?a*=2,s*=2,w*=4:0;(d%8==7)?a|=ph,s|=pl,w|=e:0;}d==256?V=((V&7<<12)!=7<<12?V+_*4:(V&992)==928?V&35871^_*2:(V&992)==992?V&35871:V&35871|V+32&992)&~1055
|T&1055:0;}y==-1&&d>279&&d<305?V=V&33823|T&31712:0;}if(y==241&&d==1){p&128?N=1:0;H|=128;SDL_UpdateTexture(tx,0,fb+_*2,512);SDL_RenderCopy(re,tx,0,0);SDL_Ren\
derPresent(re);for(SDL_Event ev;SDL_PollEvent(&ev);)if(ev.type==256)Q+0;}y==-1&&d==1?H=0:0;++d==341?d=0,y=y==260?-1:y+1:0;}}}U(made_by_binji_oct_2022______);
